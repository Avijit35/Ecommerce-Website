...
import { getData } from "../lib/index.tsx";
import {
  Menu,
  MenuButton,
  MenuItem,
...
import type { CategoryProps } from "../../type.ts";
                ...
                {categories.map((item: CategoryProps) => (
                  <MenuItem key={item?._id}>
                    <Link
                      ...
                      className="flex w-full items-center rounded-lg gap-2 py-2 px-3 data-[focus]:bg-white/20 tracking-wide"
                    >
                      <img
                        src={item?.image}
                        alt="CategoryImage"
